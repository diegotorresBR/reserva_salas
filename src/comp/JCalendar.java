...
public class JCalendar extends JComboBox {
  ...
  private class LiquidDateComboBoxUI extends LiquidComboBoxUI{
  ...
  public class DatePanel extends javax.swing.JPanel {
    ...
    /**
     * This method is called from within the constructor to initialize the form. black
    ...
    private void initComponents() {
      ...
      previousYear.setFont(new java.awt.Font("Gill Sans MT", 0, 9));
      ...
      previousMonth.setFont(new java.awt.Font("Gill Sans MT", 0, 9));
      ...
      dateLabel.setFont(new java.awt.Font("Gill Sans MT", 1, 11));
      dateLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
      dateLabel.setText("Abril, 2006");
      navegatePanel.add(dateLabel);
      dateLabel.setBounds(44, 3, 105, 14);

      nextMonth.setFont(new java.awt.Font("Gill Sans MT", 0, 9));
      nextMonth.setText(">");
      ...
      nextYear.setFont(new java.awt.Font("Gill Sans MT", 0, 9));
      nextYear.setText(">>");
    ...
    private void initArrayOfDays() {
      for (int i = 0; i < 42; i++) {
        ...
        day[i].setBackground(Color.WHITE);//cor do fundo
      }
    }

    public void fillDaysPanel(int firstDayOfMonth, int maximumDayOfMonth) {
      int index = 1;
      daysPanel.removeAll();
      initArrayOfDays();
      String j;//temporaria
        
       int num_id = FrameTeste.getNum_id();
       
       //System.out.print("pegou esassdf " + num_id + " fdf");
       
        List<ReservaBeans> datas  = new ArrayList<ReservaBeans>();
        ReservaBeans r;
        ReservaDAO re = new ReservaDAO();
        String data = null;
        String data_str;
        ResultSet rs = null;
        
        rs = re.getReservas_por_sala(num_id);
          try {
              while(rs.next()){
                  Long id = Long.parseLong(rs.getString("id"));
                  data = rs.getString("inicio");
                  r = new ReservaBeans(data, id);
                  datas.add(r);
        ...
        if (i + 1 >= firstDayOfMonth && index <= maximumDayOfMonth) {
          ...
          //begin
            ...
            //for (int x = 0; x < 42; x++){
                ...
                //int mes  = Calendar.DECEMBER;
                //System.out.println(mes); //gc.get(Calendar.MONTH) == Calendar.DECEMBER
                
                
                
//                for (int s = 0; s < datas.size(); s++) {  
//            //System.out.println(datas.get(i).getId());
//            //System.out.println(datas.get(i).getData_reserva());
//                    
//            data_str = datas.get(s).getData_reserva_inicio();
//            System.out.println(data_str);
//            String data2[] = data_str.split("-");
//            String data3[] = null;
//            for (int ix=0;ix<data2.length;ix++){
//                System.out.println(data2[ix]);
//                data3= data2[ix].split(":");
//                
//            }
//            
//            for(int xd=0; xd<data3.length; xd++){
//                System.out.println(data3[xd]);
//            }
//            int a , b, c;
//            
//            a = Integer.parseInt(data2[0]);//ano
//            b = Integer.parseInt(data2[1]);//mes
//            c = Integer.parseInt(data2[2]);//dia
//            
//            System.out.println(a);
////            System.out.println(data1[b]);
////            System.out.println(data1[c]);
//                    
//                    if(gc.get(Calendar.YEAR) == a){
//                        if (gc.get(Calendar.MONTH) == (b-1)){
//                            if(num==c){
//                            day[i].setBackground(Color.LIGHT_GRAY);//cor que envolve o dia
//                            day[i].setForeground(Color.YELLOW);
//                            }
//            //} 
//                        }
//                    }
...
//cor dos dias selecionados
            if (index == selectedDay) {
              //day[i].setBackground(Color.BLACK);//cor que envolve o dia
              //day[i].setForeground(Color.DARK_GRAY);
              selectedLabel = day[i];
            } else {
              if (i % 7 != 0) {
                day[i].setForeground(UIManager.getDefaults().getColor("label.foreground"));
                //  day[i].setForeground(UIManager.getDefaults().getColor(Color.BLUE));
              } //else {
            ...
            if (day[i].getText().equals(String.valueOf(selectedDay))) {
              ...
              day[i].setForeground(Color.LIGHT_GRAY);
              selectedLabel = day[i];
            }
            ...
            if (day[i] != selectedLabel) {
              if (i % 7 != 0) {
                //day[i].setForeground(UIManager.getDefaults().getColor("label.foreground"));
                  day[i].setForeground(Color.BLACK);//colorir os dias de semana
              
              } else {
                day[i].setForeground(Color.RED);//colorir os dias de domingo
              }
            }
          }
...
//        setDaysAndFill();
  ...
  public void updateUI() {
    ...
    } else if(comboBoxUI instanceof LiquidComboBoxUI){
        comboBoxUI = new LiquidDateComboBoxUI();
    }
